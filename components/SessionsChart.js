...
const generateMonthlyData = () => {
  ...
  const values = [200, 3000, 2500, 4000, 3500, 5000, 600, 7900, 8000, 9000, 8500, 10000, 11000, 12000, 11500, 13000, 12500, 14000, 15000, 16500, 17000, 18000, 17500, 19000, 20000];
  let index = 0;
  ...
  while (currentDate <= endDate) {
    ...
    const baseValue = values[index] || 20000;
    const variation = (Math.random() - 0.5) * 3000;
    
    months.push({
      name: `${month} ${year}`,
      value: Math.max(1000, baseValue + variation),
